...
- 支持按交易所、币种、未平仓额、现货成交额、合约成交额、资金费率、下次资金费率、上下限和结算周期排序或筛选
- 可独立隐藏 Binance Alpha 与股票类合约；股票类涵盖股票/ETF、港股、韩股、指数、盘前和大宗商品
- 资金费率可在 8H 等效费率和 1Y 简单年化之间切换
- 资金费率后显示 Margin Pool 最新杠杆借币日利率的简单年化值，并支持排序
- 点击币名打开历史资金费率；点击最新价格会在新标签打开对应交易所的合约页面；点击借款利息会在新标签打开对应 Margin Pool 资产
...
- 页面复用同源 Margin Pool 批量接口返回的最新借币日利率并按 `日利率 × 365` 显示年化；打开历史图时再读取逐币利率历史，并按当前页面周期换算为 8H 等效值或 1Y 简单年化。
